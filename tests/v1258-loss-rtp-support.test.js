...
test('loss branch responds directly, de-escalates safely, and does not open forced human wait',()=>{
  ...
  assert.match(block,/lossReplyForEmotion/);
  assert.match(block,/unsafeLossTemplate/);
