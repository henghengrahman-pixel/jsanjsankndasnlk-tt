export class TelegramClient {
  ...
  async getWebhookInfo(){ return this.call('getWebhookInfo',{},15000); }
  ...
  async answerCallbackQuery(id,text=''){ return this.call('answerCallbackQuery',{callback_query_id:String(id),text:String(text||'').slice(0,180)},5000); }
  async editMessageReplyMarkup(chatId,messageId,replyMarkup={inline_keyboard:[]}){
    return this.call('editMessageReplyMarkup',{chat_id:String(chatId),message_id:Number(messageId),reply_markup:replyMarkup},10000);
  }
