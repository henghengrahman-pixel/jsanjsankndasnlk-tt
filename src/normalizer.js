const typoMap = new Map(Object.entries({
  ...
  'wd':'withdraw','wede':'withdraw','wdraw':'withdraw','wdrw':'withdraw','wthdraw':'withdraw','withdrw':'withdraw','widraw':'withdraw','witdraw':'withdraw','withdrawl':'withdraw',
...
export function normalizeText(text='') {
  return String(text)
    ...
    .replace(/\blupapsw\b/g, 'lupa password')
    .replace(/\blupapw\b/g, 'lupa password')
    .replace(/\blupapasword\b/g, 'lupa password')
    .replace(/\blupapassword\b/g, 'lupa password')
